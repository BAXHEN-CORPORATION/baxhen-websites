...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('super-admin', 'baxhen-admin', 'baxhen-editor', 'client-admin', 'client-editor', 'client-viewer');
  CREATE TYPE "public"."enum_tenants_status" AS ENUM('lead', 'onboarding', 'active', 'suspended', 'archived');
  CREATE TYPE "public"."enum_clients_status" AS ENUM('lead', 'onboarding', 'active', 'inactive');
  CREATE TYPE "public"."enum_sites_enabled_locales" AS ENUM('pt', 'en');
  CREATE TYPE "public"."enum_sites_site_type" AS ENUM('business-presence', 'lead-generation', 'combined', 'custom');
  CREATE TYPE "public"."enum_sites_status" AS ENUM('draft', 'preview', 'approved', 'published', 'suspended', 'archived');
  CREATE TYPE "public"."enum_sites_template" AS ENUM('business-presence', 'lead-generation', 'legal-page', 'contact-page');
  CREATE TYPE "public"."enum_sites_default_locale" AS ENUM('pt', 'en');
  ...
  CREATE TYPE "public"."enum_pages_page_type" AS ENUM('standard', 'legal', 'landing', 'custom');
  ...
  CREATE TYPE "public"."enum__pages_v_version_page_type" AS ENUM('standard', 'legal', 'landing', 'custom');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('pt', 'en');
  CREATE TYPE "public"."enum_media_usage" AS ENUM('public-website', 'private-document', 'platform-asset');
  CREATE TYPE "public"."enum_domains_type" AS ENUM('baxhen-preview', 'baxhen-subdomain', 'custom-domain');
  CREATE TYPE "public"."enum_domains_status" AS ENUM('pending', 'verified', 'active', 'failed', 'disabled');
  CREATE TYPE "public"."enum_service_plans_billing_interval" AS ENUM('monthly', 'annual', 'one-time');
  CREATE TYPE "public"."enum_service_plans_currency" AS ENUM('EUR', 'USD', 'GBP');
  CREATE TYPE "public"."enum_contracts_status" AS ENUM('draft', 'sent', 'signed', 'active', 'expired', 'cancelled');
  CREATE TYPE "public"."enum_contracts_currency" AS ENUM('EUR', 'USD');
  CREATE TYPE "public"."enum_contract_documents_document_type" AS ENUM('contract', 'addendum', 'nda', 'other');
  CREATE TYPE "public"."enum_deployments_status" AS ENUM('deploying', 'deployed', 'failed');
  CREATE TYPE "public"."enum_deployments_environment" AS ENUM('production', 'preview');
  ...
  CREATE TABLE "tenants" (
  	...
  	"status" "enum_tenants_status" DEFAULT 'lead' NOT NULL,
  	"client_id" integer,
  ...
  CREATE TABLE "clients" (
  	...
  	"status" "enum_clients_status" DEFAULT 'lead' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "sites" (
  	...
  	"name" varchar NOT NULL,
  	"slug" varchar NOT NULL,
  	"site_type" "enum_sites_site_type" DEFAULT 'business-presence' NOT NULL,
  	"status" "enum_sites_status" DEFAULT 'draft' NOT NULL,
  	"template" "enum_sites_template" DEFAULT 'business-presence' NOT NULL,
  	"default_locale" "enum_sites_default_locale" DEFAULT 'pt' NOT NULL,
  	"primary_domain" varchar,
  	"preview_domain" varchar,
  	"theme" jsonb,
  	"contact_configuration" jsonb,
  	"social_links" jsonb,
  	"analytics_configuration" jsonb,
  	"seo_defaults" jsonb,
  ...
  CREATE TABLE "media" (
  	...
  	"tenant_id" integer,
  	"site_id" integer,
  	"usage" "enum_media_usage" DEFAULT 'public-website',
  	"folder_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "domains" (
  	...
  	"type" "enum_domains_type" DEFAULT 'baxhen-preview' NOT NULL,
  ...
  CREATE TABLE "service_plans" (
  	...
  	"billing_interval" "enum_service_plans_billing_interval" DEFAULT 'annual' NOT NULL,
  	"price" numeric NOT NULL,
  	"currency" "enum_service_plans_currency" DEFAULT 'EUR' NOT NULL,
  ...
  CREATE TABLE "contracts" (
  	...
  	"annual_infrastructure_price" numeric,
  	"currency" "enum_contracts_currency" DEFAULT 'EUR',
  ...
  CREATE TABLE "contract_documents" (
  	...
  	"document_type" "enum_contract_documents_document_type" NOT NULL,
  ...
  CREATE TABLE "deployments" (
  	...
  	"tenant_id" integer NOT NULL,
  	"site_id" integer NOT NULL,
  	"status" "enum_deployments_status" DEFAULT 'deploying' NOT NULL,
  	"deployed_at" timestamp(3) with time zone,
  	"commit_hash" varchar,
  	"environment" "enum_deployments_environment" DEFAULT 'production',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"media_id" integer,
  	"domains_id" integer,
  	"service_plans_id" integer,
  	"contracts_id" integer,
  	"contract_documents_id" integer,
  ...
  CREATE TABLE "platform_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"platform_name" varchar DEFAULT 'Baxhen' NOT NULL,
  	"support_email" varchar DEFAULT 'hello@baxhen.pt',
  ...
  ALTER TABLE "tenants" ADD CONSTRAINT "tenants_client_id_clients_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."clients"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "contracts" ADD CONSTRAINT "contracts_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "contracts" ADD CONSTRAINT "contracts_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "contracts" ADD CONSTRAINT "contracts_service_plan_id_service_plans_id_fk" FOREIGN KEY ("service_plan_id") REFERENCES "public"."service_plans"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "contract_documents" ADD CONSTRAINT "contract_documents_client_id_clients_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."clients"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "contract_documents" ADD CONSTRAINT "contract_documents_contract_id_contracts_id_fk" FOREIGN KEY ("contract_id") REFERENCES "public"."contracts"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deployments" ADD CONSTRAINT "deployments_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "deployments" ADD CONSTRAINT "deployments_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_contract_documents_fk" FOREIGN KEY ("contract_documents_id") REFERENCES "public"."contract_documents"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "tenants_client_idx" ON "tenants" USING btree ("client_id");
  ...
  CREATE UNIQUE INDEX "service_plans_code_idx" ON "service_plans" USING btree ("code");
  ...
  CREATE INDEX "contracts_client_idx" ON "contracts" USING btree ("client_id");
  CREATE INDEX "contracts_tenant_idx" ON "contracts" USING btree ("tenant_id");
  CREATE INDEX "contracts_site_idx" ON "contracts" USING btree ("site_id");
  CREATE INDEX "contracts_service_plan_idx" ON "contracts" USING btree ("service_plan_id");
  ...
  CREATE INDEX "contract_documents_client_idx" ON "contract_documents" USING btree ("client_id");
  CREATE INDEX "contract_documents_contract_idx" ON "contract_documents" USING btree ("contract_id");
  CREATE INDEX "contract_documents_updated_at_idx" ON "contract_documents" USING btree ("updated_at");
  CREATE INDEX "contract_documents_created_at_idx" ON "contract_documents" USING btree ("created_at");
  CREATE UNIQUE INDEX "contract_documents_filename_idx" ON "contract_documents" USING btree ("filename");
  CREATE INDEX "deployments_tenant_idx" ON "deployments" USING btree ("tenant_id");
  CREATE INDEX "deployments_site_idx" ON "deployments" USING btree ("site_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_contract_documents_id_idx" ON "payload_locked_documents_rels" USING btree ("contract_documents_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "contract_documents" CASCADE;
  ...
  DROP TYPE "public"."enum_sites_site_type";
  ...
  DROP TYPE "public"."enum_service_plans_billing_interval";
  DROP TYPE "public"."enum_service_plans_currency";
  DROP TYPE "public"."enum_contracts_status";
  DROP TYPE "public"."enum_contracts_currency";
  DROP TYPE "public"."enum_contract_documents_document_type";
